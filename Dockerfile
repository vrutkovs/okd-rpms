...
WORKDIR /rpms
RUN curl -o crio.rpm -L https://download.opensuse.org/repositories/devel:/kubic:/libcontainers:/stable:/cri-o:/1.23/Fedora_35/x86_64/cri-o-1.23.0-2.1.fc35.x86_64.rpm && \
